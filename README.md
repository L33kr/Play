...
[Скачать APK из последнего релиза](https://github.com/L33kr/Play/releases/tag/v0.2.0)

## Как пользоваться

1. Установить APK. В профиле нажать **Войти в Shikimori**, войти логином и паролем на официальной странице, нажать **Готово**.
2. Открыть аниме из каталога или своего списка. Выбрать озвучку, сезон и серию.
...
APK: `app/build/outputs/apk/debug/app-debug.apk`. В GitHub Actions APK доступен как артефакт сборки; после успешной проверки `main` workflow один раз публикует тестовый релиз `v0.2.0` и сохраняет уже опубликованные файлы без изменений.
