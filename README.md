...
[Скачать APK из последнего релиза](https://github.com/L33kr/Play/releases/latest)
...
APK: `app/build/outputs/apk/debug/app-debug.apk`. В GitHub Actions APK доступен как артефакт сборки; workflow публикации создаёт тестовый релиз при отправке тега `v*`.
